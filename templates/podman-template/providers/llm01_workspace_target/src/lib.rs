...
/// Response envelope from the workspace target helper.
...
impl Provider for Llm01Provider {
    ...
    fn schema(&self, _diags: &mut Diagnostics) -> Option<Schema> {
        Some(Schema {
            ...
            block: Block {
                version: 1,
                description: Description::plain("workspace target provider"),
                attributes: map! {
                  "endpoint" => Attribute {
                    attr_type: AttributeType::String,
                    description: Description::plain("workspace target helper base URL, e.g. https://localhost:2377"),
...
impl Resource for WorkspaceTargetResource {
    ...
    fn schema(&self, _diags: &mut Diagnostics) -> Option<Schema> {
        Some(Schema {
            ...
            block: Block {
                version: 1,
                description: Description::plain("iSCSI-backed workspace target"),
                attributes: map! {
                  "workspace" => Attribute {
                    attr_type: AttributeType::String,
